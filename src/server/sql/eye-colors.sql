...
-- ========== 莲之空女学院 (11人) ==========
UPDATE `character` SET eye_color='粉色' WHERE character_id=42;    -- 日野下花帆
UPDATE `character` SET eye_color='蓝色' WHERE character_id=43;    -- 村野沙耶香
UPDATE `character` SET eye_color='琥珀色' WHERE character_id=44;  -- 大泽瑠璃乃
UPDATE `character` SET eye_color='绿色' WHERE character_id=45;    -- 徒町小鈴
UPDATE `character` SET eye_color='紫色' WHERE character_id=46;    -- 安養寺姫芽
UPDATE `character` SET eye_color='红色' WHERE character_id=47;    -- 百生吟華
UPDATE `character` SET eye_color='紫罗兰色' WHERE character_id=50; -- 乙宗梢
UPDATE `character` SET eye_color='金棕色' WHERE character_id=51;   -- 夕雾缀理
UPDATE `character` SET eye_color='橙色' WHERE character_id=52;    -- 藤岛慈
